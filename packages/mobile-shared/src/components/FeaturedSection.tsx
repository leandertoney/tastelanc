      ...
      >
        {overlayAd && (
          <View style={[overlayStylesStatic.backdrop, { backgroundColor: getColors().overlay }]}>
            ...
            <View style={overlayStylesStatic.cardWrapper} pointerEvents="box-none">
              {/* Close button above the card */}
              <TouchableOpacity
                style={overlayStylesStatic.closeButton}
                onPress={dismissOverlay}
                hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}
              >
                <View style={overlayStylesStatic.closeButtonInner}>
              ...
              <TouchableOpacity
                style={[overlayStylesStatic.card, { backgroundColor: colors.cardBg }]}
...
const overlayStylesStatic = StyleSheet.create({
  backdrop: {
    flex: 1,
