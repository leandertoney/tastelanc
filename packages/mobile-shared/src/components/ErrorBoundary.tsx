...
function SectionErrorFallback({
  ...
  try {
    ...
    // Theme not initialized — use hardcoded fallback
    colors = { error: '#FF453A', primary: '#1A1A1A' } as any;
  }
  ...
  return (
    <View style={styles.sectionError}>
      ...
      <TouchableOpacity style={[styles.sectionRetryButton, { backgroundColor: colors.primary }]} onPress={onRetry}>
...
function ScreenErrorFallback({
  ...
  try {
    ...
    colors = { accent: '#A41E22', primary: '#1A1A1A' } as any;
  }
    ...
    return (
      <View style={styles.screenError}>
        <View style={styles.screenErrorContent}>
          ...
          <TouchableOpacity style={[styles.screenRetryButton, { backgroundColor: colors.accent }]} onPress={onRetry}>
...
// Static styles (no color dependencies or using hardcoded neutral colors)
