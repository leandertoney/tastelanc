...
const useStyles = createLazyStyles((colors) => ({
  ...
  compactCard: { backgroundColor: colors.cardBg, borderRadius: radius.md, marginBottom: 10, flexDirection: 'row' as const, alignItems: 'stretch' as const, overflow: 'hidden' as const },
  compactThumb: { width: 90, overflow: 'hidden' as const, backgroundColor: colors.cardBgElevated },
  compactThumbImg: { width: '100%' as const, height: '100%' as const },
  compactThumbFallback: { width: 90, justifyContent: 'center' as const, alignItems: 'center' as const, backgroundColor: colors.cardBgElevated, minHeight: 80 },
  compactBody: { flex: 1, padding: spacing.md, gap: 2 },
