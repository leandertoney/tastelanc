...
const useStyles = createLazyStyles((colors) => ({
  ...
  compactThumb: { width: 84, height: 84, borderRadius: radius.sm, overflow: 'hidden' as const, backgroundColor: colors.cardBgElevated },
  compactThumbImg: { width: '100%' as const, height: '100%' as const },
  compactThumbFallback: { width: 84, height: 84, borderRadius: radius.sm, backgroundColor: colors.cardBgElevated, justifyContent: 'center' as const, alignItems: 'center' as const },
