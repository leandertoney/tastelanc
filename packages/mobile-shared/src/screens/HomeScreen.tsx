...
const useStyles = createLazyStyles((colors) => ({
  ...
  centered: { flex: 1, justifyContent: 'center' as const, alignItems: 'center' as const, padding: 20 },
  errorText: { fontSize: 16, color: colors.error, textAlign: 'center' as const },
  listContent: { paddingBottom: 20 },
  emptyContainer: { padding: 40, alignItems: 'center' as const },
  emptyText: { fontSize: 16, color: colors.textMuted },
  ctaWrapper: { paddingHorizontal: spacing.md, paddingVertical: spacing.xs },
  ...
  loadMoreText: { fontSize: 15, fontWeight: '600' as const, color: colors.accent },
  rosieFab: {
