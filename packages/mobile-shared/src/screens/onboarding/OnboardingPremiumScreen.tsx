...
const useStyles = createLazyStyles((colors) => ({
  ...
  videoContainer: { width: 200, height: 200, marginBottom: 24, alignItems: 'center' as const, justifyContent: 'center' as const, borderRadius: 100, borderWidth: 4, borderColor: colors.accent, backgroundColor: '#000000', overflow: 'hidden' as const, shadowColor: colors.accent, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.6, shadowRadius: 24, elevation: 10 },
  video: { width: '100%', height: '100%' },
  headline: { fontSize: 32, fontWeight: '700' as const, color: '#FFFFFF', textAlign: 'center' as const, marginBottom: 12 },
  subheadline: { fontSize: 17, color: '#FFFFFF', opacity: 0.85, textAlign: 'center' as const, lineHeight: 24 },
