...
export default async function BestOfLancasterPage() {
  ...
  if (!list.length) return <main className="p-8 text-tastelanc-text-primary">No restaurants found.</main>;
  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-10 text-tastelanc-text-primary">
        ...
        <p className="text-tastelanc-text-muted mt-2">Top picks for restaurants, specials, and nightlife.</p>
