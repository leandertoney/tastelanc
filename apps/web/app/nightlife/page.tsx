...
export default async function NightlifePage() {
  ...
  if (!filtered.length) return <main className="p-8 text-tastelanc-text-primary">No nightlife venues found.</main>;
  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-10 text-tastelanc-text-primary">
        ...
        <p className="text-tastelanc-text-muted mt-2">Find bars, breweries, and nightlife spots.</p>
