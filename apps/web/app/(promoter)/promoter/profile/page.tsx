...
export default function PromoterProfilePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-bold text-tastelanc-text-primary">Profile</h1>
        <p className="text-tastelanc-text-muted mt-1">Update your artist information</p>
      </div>
      ...
      <form onSubmit={handleSave}>
        <Card className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-tastelanc-text-secondary">Social Links</h3>

            <div>
              <label className="block text-xs text-tastelanc-text-faint mb-1">Website</label>
              <div className="relative">
                <Globe className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-tastelanc-text-faint" />
                <input
                  type="url"
                  value={website}
            ...
            <div>
              <label className="block text-xs text-tastelanc-text-faint mb-1">Instagram</label>
              <div className="relative">
                <Instagram className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-tastelanc-text-faint" />
                <input
                  type="text"
                  value={instagram}
