...
export async function PATCH(request: Request, { params }: RouteParams) {
  try {
    ...
    const ALLOWED_FIELDS = ['is_active', 'is_verified', 'tier_id', 'admin_notes', 'has_pick_badge', 'is_lrw'];
    ...
    const { data: updated, error } = await serviceClient
      ...
      .update(updates)
      .eq('id', id)
      .select('id, name, is_active, is_verified, tier_id, admin_notes, has_pick_badge, is_lrw, tiers(name, display_name)')
      .single();
