 ...
 * Proxies to the send-notifications edge function, which routes through
 * the gateway (quiet hours, dedup, throttle enforced automatically).
 */
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Proxy to edge function — gateway handles quiet hours, dedup, and throttle
