...
export async function GET(request: Request) {
  try {
    ...
    let query = serviceClient
      .from('restaurants')
      .select('id, name, city, state, phone, website, is_active, tier_id, tiers(name), contact_name, contact_phone, contact_email, contact_title, address, zip_code, categories')
