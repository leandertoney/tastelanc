    ...
    <div className="py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-tastelanc-text-primary mb-2">Vote for {BRAND.countyShort}&apos;s Best</h1>
          <p className="text-tastelanc-text-muted max-w-2xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-lancaster-gold/20 to-tastelanc-accent/20 rounded-xl p-8 mb-12 text-center">
          <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">Ready to Vote?</h2>
          <p className="text-tastelanc-text-secondary mb-6">
        ...
        {/* Categories */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-6">Vote Categories</h2>
            ...
            {VOTE_CATEGORIES.map((category) => (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-tastelanc-text-primary">{category.name}</h3>
                </div>
                <p className="text-sm text-tastelanc-text-muted">View leaderboard &rarr;</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Current Leaders */}
        <div>
          <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-6 flex items-center gap-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {topRestaurants.map((restaurant, index) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-tastelanc-text-primary">{restaurant.name}</h3>
        ...
        <div className="mt-16 bg-tastelanc-card rounded-xl p-8">
          <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-6 text-center">How Voting Works</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-tastelanc-text-primary mb-2">Create an Account</h3>
              <p className="text-tastelanc-text-muted text-sm">Sign up for free to start voting for your favorites</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-tastelanc-accent rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-white">2</span>
              </div>
              <h3 className="font-semibold text-tastelanc-text-primary mb-2">Cast Your Votes</h3>
              <p className="text-tastelanc-text-muted text-sm">Vote in different categories each month (premium gets 4 votes!)</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-tastelanc-accent rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-white">3</span>
              </div>
              <h3 className="font-semibold text-tastelanc-text-primary mb-2">See the Winners</h3>
              <p className="text-tastelanc-text-muted text-sm">Watch the leaderboards update and see who comes out on top</p>
            </div>
          </div>
        </div>
      </div>
