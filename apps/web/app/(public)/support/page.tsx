  ...
  return (
    <div className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-tastelanc-text-primary mb-8">Support</h1>
        <p className="text-tastelanc-text-muted mb-8">We&apos;re here to help you get the most out of {BRAND.name}.</p>

        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">Contact Us</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">Frequently Asked Questions</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">What is {BRAND.name}?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">How do I create an account?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">How do I delete my account?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">Is {BRAND.name} free to use?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">How can I report incorrect information?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">Troubleshooting</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">App not loading properly?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">Location services not working?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-2">Not receiving notifications?</h3>
                <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">For Restaurant Owners</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">Response Time</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
