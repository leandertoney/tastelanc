  ...
  return (
    <div className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-tastelanc-text-primary mb-8">Terms of Service</h1>
        <p className="text-tastelanc-text-muted mb-8">Last updated: November 28, 2025</p>

        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">2. Description of Service</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">4. Acceptable Use</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">5. Content and Information</h2>

            <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-3">5.1 Our Content</h3>
            <p className="text-tastelanc-text-secondary leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-3">5.2 Third-Party Content</h3>
            <p className="text-tastelanc-text-secondary leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-tastelanc-text-primary mb-3">5.3 User Content</h3>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">6. Disclaimer of Warranties</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">7. Limitation of Liability</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">8. Indemnification</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">9. Third-Party Links</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">10. Modifications to Service</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">11. Changes to Terms</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">12. Governing Law</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">13. Severability</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-tastelanc-text-primary mb-4">14. Contact Us</h2>
            <p className="text-tastelanc-text-secondary leading-relaxed">
