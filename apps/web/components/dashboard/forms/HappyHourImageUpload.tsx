...
export default function HappyHourImageUpload({ value, onChange, restaurantId }: HappyHourImageUploadProps) {
  ...
  const handleUpload = useCallback(async (file: File) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/dashboard/happy-hours/upload?restaurant_id=${restaurantId}`,
        {
          method: 'POST',
          body: formData,
        }
