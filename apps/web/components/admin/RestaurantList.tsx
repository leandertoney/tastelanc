    ...
    <div>
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-1.5 text-sm text-tastelanc-text-muted">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm transition-colors ${
                  tierFilter === opt.value
                    ...
                    : 'bg-tastelanc-surface border border-tastelanc-surface-light text-tastelanc-text-muted hover:text-tastelanc-text-primary'
                }`}
              >
                {opt.label}
              </button>
      ...
      {paginatedRestaurants.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-tastelanc-text-primary mb-2">
                ...
                <div className="flex items-start gap-4">
                  {restaurant.logo_url ? (
                    ...
                    <div className="w-16 h-16 bg-tastelanc-surface-light rounded-lg flex items-center justify-center">
                      <Store className="w-8 h-8 text-tastelanc-text-faint" />
                    </div>
                  )}
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <Link
                        ...
                        className="text-lg font-semibold text-tastelanc-text-primary hover:text-tastelanc-accent"
                      >
                        {restaurant.name}
                      </Link>
                ...
                <div className="text-right">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {restaurant.is_active ? (
                      ...
                      <span className="inline-flex items-center gap-1 text-xs text-tastelanc-text-faint">
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-lg bg-tastelanc-surface border border-tastelanc-surface-light text-tastelanc-text-muted hover:text-tastelanc-text-primary disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <ChevronLeft className="w-5 h-5" />
            </button>
            <span className="text-sm text-tastelanc-text-primary px-3">
