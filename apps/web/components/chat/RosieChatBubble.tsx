  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={openChat}
          className="fixed bottom-6 right-6 z-40 w-16 h-16 rounded-full overflow-hidden shadow-lg hover:shadow-[0_0_20px_rgba(164,30,34,0.4)] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-tastelanc-accent focus:ring-offset-2 focus:ring-offset-tastelanc-bg animate-chat-pulse"
