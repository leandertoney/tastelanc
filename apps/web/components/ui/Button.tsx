      ...
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-tastelanc-accent focus:ring-offset-2 focus:ring-offset-tastelanc-bg disabled:opacity-50 disabled:cursor-not-allowed',
          {
            ...
            'bg-tastelanc-surface hover:bg-tastelanc-surface-light text-tastelanc-text-primary': variant === 'secondary',
            'border border-tastelanc-surface-light hover:bg-tastelanc-surface text-tastelanc-text-primary': variant === 'outline',
            'hover:bg-tastelanc-surface text-tastelanc-text-secondary hover:text-tastelanc-text-primary': variant === 'ghost',
