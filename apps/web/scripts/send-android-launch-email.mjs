...
/**
 * Android Launch Email Campaign
 * Sends the Android launch announcement to all waitlist members
 *
 * Usage: node scripts/send-android-launch-email.mjs
 */
...
// Android Launch email content
const CAMPAIGN = {
  name: 'Android App Launch Announcement',
  subject: 'TasteLanc is Now on Android! Download Today',
  previewText: "Great news for Android users - TasteLanc is here!",
  headline: 'TasteLanc is Now on Android!',
  body: `Great news — TasteLanc is now available on Google Play!

We heard you loud and clear. If you've been waiting to try TasteLanc on your Android device, your wait is over.

Download the app today and start discovering Lancaster's best restaurants, happy hours, and nightlife — all in one place.
...
Thanks for being part of the TasteLanc community!`,
  ctaText: 'Download for Android',
  ctaUrl: 'https://play.google.com/store/apps/details?id=com.tastelanc.app',
  secondaryCtaText: 'Download for iPhone',
  secondaryCtaUrl: 'https://apps.apple.com/us/app/tastelanc/id6755852717',
};
          ...
          <tr>
            <td style="padding: 0 16px;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin: 32px 0;">
                <tr>
                  <td align="center">
                    <a href="${CAMPAIGN.ctaUrl}" target="_blank" style="display: inline-block; background: #34A853; color: #FFFFFF; padding: 16px 40px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px; margin-bottom: 12px;">
                      ${CAMPAIGN.ctaText}
                    </a>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding-top: 12px;">
                    <a href="${CAMPAIGN.secondaryCtaUrl}" target="_blank" style="display: inline-block; background: #E63946; color: #FFFFFF; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">
...
async function main() {
  console.log('🤖 Android Launch Email Campaign');
  console.log('================================\n');
