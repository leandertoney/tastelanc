 ...
 *
 * This is the AI's enhanced persona for generating blog content.
 * She's the market's definitive food authority - not just a recommendation engine,
...
export const ROSIE_AUTHOR_BIO = `${BRAND.aiName} lives and breathes ${BRAND.countyShort}'s food scene. She knows every happy hour worth your time, the spots your foodie friends haven't discovered yet, and has strong opinions about where you should actually eat tonight. Think of her as that friend who's always got a solid recommendation.`;

export const ROSIE_SHORT_BIO = `Your go-to guide for ${BRAND.countyShort} dining. Recommendations you can actually trust.`;
...
export const BLOG_TOPICS = [
  ...
  { id: 'tourist-guide', name: 'Tourist Guide', description: `What to eat if you're visiting ${BRAND.countyShort}` },
  ...
  { id: 'neighborhood-spotlight', name: 'Neighborhood Spotlight', description: `Deep dive into a ${BRAND.countyShort} neighborhood` },
  ...
  { id: 'app-feature', name: 'App Feature Spotlight', description: `How to use ${BRAND.name} features` },
  ...
  // Cuisine-specific
  { id: 'italian-guide', name: 'Italian Guide', description: `Best Italian food in ${BRAND.countyShort}` },
  ...
  { id: 'food-trends', name: 'Food Trends', description: `What's trending in ${BRAND.countyShort} food` },
