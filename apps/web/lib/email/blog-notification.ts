          ...
          <tr>
            <td style="background-color: #1A1A1A; border-radius: 12px; padding: 32px;">
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                <tr>
                  <td style="background-color: ${BRAND.colors.dark.gold}; color: #000; font-size: 11px; font-weight: bold; padding: 4px 10px; border-radius: 4px; text-transform: uppercase; letter-spacing: 0.5px;">
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color: ${BRAND.colors.dark.gold}; border-radius: 8px;">
