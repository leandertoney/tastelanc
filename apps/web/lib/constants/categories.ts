import { RestaurantCategory } from '@/types/database';

/**
 * Centralized category definitions for TasteLanc
 * Used across the app for consistent filtering and display
 */
...
// Simple flat list for backward compatibility
