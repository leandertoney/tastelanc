...
const rosieAnimated = require('../../assets/animations/rosie_dark_animated.mp4');
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <View style={styles.rosieHeaderAvatar}>
              <VideoView
                player={rosiePlayer}
                style={styles.rosieHeaderVideo}
                contentFit="cover"
            ...
            isTyping ? (
              <View style={styles.typingContainer}>
                ...
                <View style={styles.typingBubble}>
                  ...
                  <Text style={styles.typingText}>Rosie is typing...</Text>
                </View>
              </View>
            ) : null
          }
