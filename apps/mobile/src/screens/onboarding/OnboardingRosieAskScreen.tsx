...
const videoSource = require('../../../assets/animations/rosie_dark_animated.mp4');
...
export default function OnboardingRosieAskScreen({ navigation }: Props) {
  ...
  const rosieAnimatedStyle = useAnimatedStyle(() => ({
    opacity: rosieOpacity.value,
    transform: [{ scale: rosieScale.value }],
  }));
      ...
      <View style={styles.content}>
        ...
        <Animated.View style={[styles.headerSection, titleAnimatedStyle]}>
          <Text style={styles.headline}>
            Ask <Text style={styles.rosieText}>Rosie</Text> anything
          </Text>
        </Animated.View>
        ...
        <View style={styles.questionsContainer}>
          ...
          <Animated.View style={[styles.taglineContainer, taglineAnimatedStyle]}>
            <Text style={styles.tagline}>She knows Lancaster inside and out.</Text>
          </Animated.View>
        </View>
      </View>
