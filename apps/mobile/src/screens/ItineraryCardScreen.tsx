 ...
 * Instagram Stories. Shows 3 curated stops with images, walk times,
 * and TasteLanc branding. Users screenshot to share — no native
...
// Keyed by TimeSlot so it works for both 2-stop and 3-stop plans.
...
// Mood-specific slot label overrides — keyed by TimeSlot so it works
// for both 2-stop and 3-stop plans. "Dinner" becomes "Drinks & Bites"
// on a bar crawl, "Nightcap" on a date night, etc.
...
export default function ItineraryCardScreen() {
  ...
  const handleEdit = useCallback(() => {
    // Go back to the builder — items are already generated
    navigation.goBack();
  }, [navigation]);
        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.stopsContainer}>
            {items.map((item, index) => {
              ...
              // Use mood-specific label override if available, otherwise default
