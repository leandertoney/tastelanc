...
export const BRAND: AppBrand = {
  ...
  aiName: 'Dreamie',
  mollieGreeting:
    "Hi! I'm Dreamie, your TasteFayetteville AI assistant. I can help you discover restaurants, find deals, and plan your next dining experience in Fayetteville. What are you in the mood for today?",
  ...
  palette: {
    background: '#1E3044',  // dark navy (primary bg — Dreamville blue)
