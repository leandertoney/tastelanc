...
// Market scope — TasteOceanCity only syncs Ocean City restaurants
const MARKET_ID = 'PLACEHOLDER_OCEAN_CITY_MARKET_UUID'; // ocean-city-md
...
async function createGeofence(radarSecretKey, restaurant) {
  ...
  const body = {
    ...
    enabled: true,
    metadata: { market_id: MARKET_ID, market: 'ocean-city-md' },
  };
