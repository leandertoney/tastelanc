...
// Using production config for all environments (single Supabase project)
const DEV_CONFIG = {
  ...
  // RevenueCat Google Play public API key (RevenueCat > TasteCumberland (Play Store))
  REVENUECAT_API_KEY_ANDROID: 'goog_HFaYzBfTDLYXVzAOzvQRModMZyx',
