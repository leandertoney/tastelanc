// TODO: This file contains Lancaster-specific seasonal event data (venues, charities,
// ticket URLs, restaurant IDs). It needs to be replaced with Cumberland-specific
// event data when a similar event is organized for the Cumberland County market.
...
export const santaStumble = {
  ...
  description:
    "Donate $10 or more to get the official button (worth $0.25) that proves you're in. Dress as Santa, an elf, snowman, or anything festive and bar-hop downtown on your own schedule.",
  charities: [
